<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfferImages.aspx.cs" Inherits="admin_OfferImages" MasterPageFile="~/MasterAdmin.master" %>
...
<div class="main_content">
    ...
    <div class="operation_title" style="margin-bottom:0;">
        <div style="display:block; text-align:left; font-size:13px; margin-left:20%;"><a href="<%= Page.ResolveUrl("~/admin/OfferList.aspx") %>">Povratak</a></div>
    ...
    <div style="display:inline-block; margin-top:20px;">
        ...
        <asp:Repeater ID="rptOfferImages" runat="server">
            <HeaderTemplate>
                ...
                <thead>
                    <tr>
                    <th colspan="2" style="padding-bottom:20px; font-weight:bold">Pregled postojecih slika:</th>
                    </tr>
                </thead>
                <tbody>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    <td style="vertical-align:top; width:320px; padding-bottom:10px;">
