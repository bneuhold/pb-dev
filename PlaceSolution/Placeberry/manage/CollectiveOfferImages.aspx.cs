...
public partial class manage_CollectiveOfferImages : System.Web.UI.Page
{
    ...
    void btnUploadNewImagePreview_Click(object sender, EventArgs e)
    {
        ...
        if (this.fuAddNewImage.HasFile)
        {
            ...
            if (type == "image/jpeg" || type == "image/gif" || type == "image/png")
            {
                ...
                imgThumb.Src = String.Format("/manage/picpreview.aspx?what={0}&content={1}", "imageuploadpreview", Server.UrlEncode(type));
