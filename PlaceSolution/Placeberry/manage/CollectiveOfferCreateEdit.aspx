<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectiveOfferCreateEdit.aspx.cs" Inherits="manage_CollectiveOfferCreateEdit" MasterPageFile="~/MasterHome.master" %>
...
<div style="display:inline-block;">
    ...
    <table class="offer_form">
        <tr>
            <td colspan="2" style="text-align:left; padding-bottom:30px;"><a href="<%= Page.ResolveUrl("~/manage/CollectiveOfferList.aspx") %>">Povratak na pregled ponuda</a></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Prava cijena:</td><td><asp:TextBox runat="server" ID="tbPriceReal"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Ušteda:</td><td><asp:TextBox runat="server" ID="tbPriceSave"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Cijena:</td><td><asp:TextBox runat="server" ID="tbPrice"></asp:TextBox></td>
        </tr>
        <tr>
