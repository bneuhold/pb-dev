...
public partial class manage_CollectiveOfferList : System.Web.UI.Page
{
    ...
    void grdOffers_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                lblDateStart.Text = offer.DateStart.HasValue ? offer.DateStart.Value.ToString("dd.MM.yyyy") : "-";
            }

            Label lblDateEnd = e.Row.FindControl("lblDateEnd") as Label;
            if (lblDateEnd != null)
            {
                lblDateEnd.Text = offer.DateEnd.HasValue ? offer.DateEnd.Value.ToString("dd.MM.yyyy") : "-";
            }
            ...
            if (hlEdit != null)
            {
                hlEdit.NavigateUrl = Page.ResolveUrl("~/manage/CollectiveOfferCreateEdit.aspx?offerid=" + offer.OfferId.ToString());
            }
            ...
            if (hlEditTrans != null)
            {
                hlEditTrans.NavigateUrl = Page.ResolveUrl("~/manage/CollectiveOfferTranslations.aspx?offerid=" + offer.OfferId.ToString());
            }

            HyperLink hlImages = e.Row.FindControl("hlImages") as HyperLink;
            if (hlImages != null)
            {
                hlImages.NavigateUrl = Page.ResolveUrl("~/manage/CollectiveOfferImages.aspx?offerid=" + offer.OfferId.ToString());
            }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            this.hlCreateNewOffer.NavigateUrl = "http://" + Request.Url.Authority + "/manage/CollectiveOfferCreateEdit.aspx";
