...
public partial class manage_CollectiveOfferCreateEdit : System.Web.UI.Page
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        if (offer != null)
        {
            ...
            if (fillOfferValues)
            {
                ...
                this.tbPriceReal.Text = offer.PriceReal.HasValue ? offer.PriceReal.Value.ToString() : string.Empty;
                this.tbPriceSave.Text = offer.PriceSave.HasValue ? offer.PriceSave.Value.ToString() : string.Empty;
                this.tbPrice.Text = offer.Price.HasValue ? offer.Price.Value.ToString() : string.Empty;
                ...
                this.tbDateStart.Text = offer.DateStart.HasValue ? offer.DateStart.Value.ToString("dd.MM.yyyy") : string.Empty;
                this.tbDateEnd.Text = offer.DateEnd.HasValue ? offer.DateEnd.Value.ToString("dd.MM.yyyy") : string.Empty;
                this.tbDateCouponStart.Text = offer.DateCouponStart.HasValue ? offer.DateCouponStart.Value.ToString("dd.MM.yyyy") : string.Empty;
                this.tbDateCouponEnd.Text = offer.DateCouponEnd.HasValue ? offer.DateCouponEnd.Value.ToString("dd.MM.yyyy") : string.Empty;
    ...
    private List<Collective.Category> GetCategories()
    {
        if (_lstCats == null)
        {
            _lstCats = Collective.Category.ListCategories(null);
        }
