<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfferTranslations.aspx.cs" Inherits="admin_OfferTranslations" MasterPageFile="~/MasterAdmin.master" %>
...
<div class="grid">
    ...
    <div class="operation_title">
        <div style="display:block; text-align:left; font-size:13px;"><a href="<%= Page.ResolveUrl("~/admin/OfferList.aspx") %>">Povratak</a></div>
...
<div class="err_msg">
    ...
    <div class="back_link" style="text-align:center; margin-top:20px;">
        <a href="<%= Page.ResolveUrl("~/admin/OfferTranslationCreateEdit.aspx?offerid=") + GetOffer().OfferId.ToString() %>">Dodaj novi prijevod</a>
    </div>
