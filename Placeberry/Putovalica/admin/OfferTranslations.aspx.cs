...
public partial class admin_OfferTranslations : System.Web.UI.Page
{
    ...
    void grdOfferTrans_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hlEdit.NavigateUrl = Page.ResolveUrl("~/admin/OfferTranslationCreateEdit.aspx?offerid=" + offtrans.OfferId.ToString() + "&langid=" + offtrans.LanguageId.ToString());
