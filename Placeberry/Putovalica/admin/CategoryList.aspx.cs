...
public partial class admin_CategoryList : System.Web.UI.Page
{
    ...
    void grdCategories_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (hlEditTrans != null)
            {
                string url = "http://" + Request.Url.Authority + "/admin/CategoryTranslations.aspx?catid=" + cat.Id;
    ...
    {
        List<Collective.Category> lst = Collective.Category.ListCategoriesForAdmin(null);
