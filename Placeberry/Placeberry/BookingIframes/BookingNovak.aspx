<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookingNovak.aspx.cs" Inherits="BookingIframes_BookingNovak" %>
...
<body>
    ...
    <div class="select_text" style="margin-bottom:10px;"><%= Resources.booking.Apartment %>: <asp:Label runat="server" ID="lblAppartmentName" Font-Bold="true"></asp:Label></div>
